...
Förutom de [inställningar](http://code.google.com/p/oppna-program/wiki/Sokkomponenten_HsaTools_Search_composite_svc) som kan göras i konfigurationsfiler går det att skicka med några GET-parametrar som påverkar utseendet av HRIV.
