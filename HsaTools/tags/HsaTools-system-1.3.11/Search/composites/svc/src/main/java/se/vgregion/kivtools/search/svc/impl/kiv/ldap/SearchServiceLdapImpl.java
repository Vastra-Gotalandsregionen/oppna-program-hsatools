...
import se.vgregion.kivtools.search.svc.impl.kiv.ws.KivwsDeliverypointService;
...
public class SearchServiceLdapImpl implements SearchService {
	...
	// kanske ska ändras.. Kolla på detta innan det checkas in.!
	...
	public SikSearchResultList<Employment> getEmployments(String personDn)
			throws KivException {
		return this.employmentRepository.getEmployments(DN
	...
	public SikSearchResultList<Unit> searchUnits(
			...
			throws KivException {
		return this.unitRepository.searchUnits(searchUnitCriterions,
				maxSearchResult);
	}
	...
	public Unit getUnitByHsaIdAndHasNotCareTypeInpatient(String hsaId)
		...
		return this.unitRepository
				.getUnitByHsaIdAndHasNotCareTypeInpatient(hsaId);
	}
