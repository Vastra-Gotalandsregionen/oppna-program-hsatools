...
/**
 * Cache service for person cache.
 */
public class PersonCacheServiceImpl extends CacheServiceImpl<PersonCache> {
  /**
   * Constructs a new PersonCacheServiceImpl.
   * 
   * @param cacheLoader The loader for this service instance.
   */
  public PersonCacheServiceImpl(CacheLoader<PersonCache> cacheLoader) {
    super(cacheLoader);
  }
}
