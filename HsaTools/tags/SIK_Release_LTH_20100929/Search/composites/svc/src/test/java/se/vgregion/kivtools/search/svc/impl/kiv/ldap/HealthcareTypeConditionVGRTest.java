...
public class HealthcareTypeConditionVGRTest {
  ...
  public void testRealFile() {
    ...
    assertNotNull(healthcareType);
    assertEquals("1004,1020,1024,1027,1139,1412,1604,1605,1607,1609,1611,1614,1615,1616,1617,1618,1619", healthcareType.getConditions().get("hsaBusinessClassificationCode"));
    assertFalse(healthcareType.isFiltered());
    ...
    assertNotNull(healthcareType);
    assertEquals("1103,1104,1113,1133,1338,1343,1502,1513,1514,1515,1606,2103", healthcareType.getConditions().get("hsaBusinessClassificationCode"));
    assertNull("vgrAO3kod", healthcareType.getConditions().get("vgrAO3kod"));
    assertFalse(healthcareType.isFiltered());
