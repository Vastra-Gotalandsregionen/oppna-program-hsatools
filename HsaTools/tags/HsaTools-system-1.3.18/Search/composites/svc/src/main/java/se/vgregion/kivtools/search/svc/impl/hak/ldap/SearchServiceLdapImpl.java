...
public class SearchServiceLdapImpl implements SearchService {
	 ...
	 */
	@Override
	public SikSearchResultList<Unit> searchUnits(SearchUnitCriterions unit,
			int maxSearchResult) throws KivException {
		return this.unitRepository.searchUnits(unit, maxSearchResult);
	}
	...
	public SikSearchResultList<Unit> searchAdvancedUnits(Unit unit,
		...
		return this.unitRepository.searchAdvancedUnits(unit, maxSearchResult,
				sortOrder, onlyPublicUnits);
	}
	...
	public List<Employment> getEmploymentsForPerson(Person person)
			throws KivException {
		SikSearchResultList<Person> personWithEmployments = this.personRepository
				.searchPersons(person.getVgrId(), 0);
	...
	public SikSearchResultList<Person> getPersonsForUnits(List<Unit> units,
		...
		return this.personRepository.getAllPersonsInUnit(u.getHsaIdentity(),
				maxResult);
	}
	...
	public SikSearchResultList<Person> searchPersonsByDn(String dn,
			int maxSearchResult) throws KivException {
		List<Person> persons = this.personRepository.searchPersonsByDn(dn,
				maxSearchResult);
		SikSearchResultList<Person> personsSearchList = new SikSearchResultList<Person>(
				persons);
	...
	public SikSearchResultList<Person> searchPersons(
			SearchPersonCriterions person, int maxResult) throws KivException {
	...
	public Person getPersonByDn(String personDn) throws KivException {
		return this.personRepository.getPersonByDn(personDn);
	}
	...
	public byte[] getProfileImageByDn(String dn) throws KivException {
		return this.personRepository.getProfileImageByDn(dn);
	}
	 ...
	 */
	@Override
	public List<Person> getPersonByVgrManagedObject(String string)
			throws KivException {
		throw new NotImplementedException("Not used by LTH.");
	}
