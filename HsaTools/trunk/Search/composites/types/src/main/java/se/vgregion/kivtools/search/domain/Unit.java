...
public class Unit implements Serializable, Comparable<Unit> {
  ...
  public void addDeliverypointDeliveryAddress(Address deliverypointDeliveryAddress) {
    if (deliverypointDeliveryAddress != null) {
      this.deliverypointDeliveryAddress.add(deliverypointDeliveryAddress);
    }
  }

  public void addDeliverypointDeliveryAddress(List<Address> deliverypointDeliveryAddress) {
    if (deliverypointDeliveryAddress != null) {
      this.deliverypointDeliveryAddress.addAll(deliverypointDeliveryAddress);
    }
  }
  ...
  public void addDeliverypointConsigneeAddress(Address deliverypointConsigneeAddress) {
    if (deliverypointConsigneeAddress != null) {
      this.deliverypointConsigneeAddress.add(deliverypointConsigneeAddress);
    }
  }

  public void addDeliverypointConsigneeAddress(List<Address> deliverypointConsigneeAddress) {
    if (deliverypointConsigneeAddress != null) {
      this.deliverypointConsigneeAddress.addAll(deliverypointConsigneeAddress);
    }
  }
  ...
  public long getWgs84LatE6() {
    return (long) (this.wgs84Lat * 1000000);
  }
  ...
  public long getWgs84LongE6() {
    return (long) (this.wgs84Long * 1000000);
  }
