...
public class KivwsUnitMapperTest {
    ...
    public static void setupTestData() throws IOException, ClassNotFoundException {
        ...
        ObjectInputStream kivLdapFunctionInputStream = xStream.createObjectInputStream(kivLdapFunction
                .getInputStream());
        ObjectInputStream kivwsFunctionInputStream = xStream.createObjectInputStream(kivwsFunction
                .getInputStream());
    ...
    public void setUp() throws Exception {
        ...
        kivLdapMapper = new UnitMapper(codeTablesServiceMock, displayValueTranslator);
        kivwsUnitMapper = new KivwsUnitMapper(codeTablesServiceMock, displayValueTranslator);
    }

    @Test
    public void testMapFromContext() {
        // Test unit object.
        Unit kivLdapUnitResult = kivLdapMapper.mapFromContext(kivLdapObject);
        Unit kivwsUnitResult = kivwsUnitMapper.mapFromContext(kivwsObject.getUnit().get(0));
        assertResult(kivLdapUnitResult, kivwsUnitResult);
        //Test function object.
        kivLdapUnitResult = kivLdapMapper.mapFromContext(kivLdapFunctionObject);
        kivwsUnitResult = kivwsUnitMapper.mapFromContext(kivwsFunctionObject.getFunction().get(0));
        assertResult(kivLdapUnitResult, kivwsUnitResult);
    }
    ...
    public void testException(){
        kivwsUnitMapper.mapFromContext(new String());
    }
    ...
    private boolean comapreUnits(Unit kivwsUnit, Unit kivLdapUnit) {
        ...
        if (kivLdapUnit.getHsaBusinessClassificationCode() == null) {
            if (kivwsUnit.getHsaBusinessClassificationCode() != null)
                return false;
        } else if (!kivLdapUnit.getHsaBusinessClassificationCode().equals(
                kivwsUnit.getHsaBusinessClassificationCode()))
            return false;
        if (kivLdapUnit.getHsaBusinessClassificationText() == null) {
            if (kivwsUnit.getHsaBusinessClassificationText() != null)
                return false;
        } else if (!kivLdapUnit.getHsaBusinessClassificationText().equals(
                kivwsUnit.getHsaBusinessClassificationText()))
            return false;
        ...
        if (kivLdapUnit.getHsaSedfSwitchboardTelephoneNo() == null) {
            if (kivwsUnit.getHsaSedfSwitchboardTelephoneNo() != null)
                return false;
        } else if (!kivLdapUnit.getHsaSedfSwitchboardTelephoneNo().equals(
                kivwsUnit.getHsaSedfSwitchboardTelephoneNo()))
            return false;
        ...
        if (kivLdapUnit.getOrganizationalUnitNameShort() == null) {
            if (kivwsUnit.getOrganizationalUnitNameShort() != null)
                return false;
        } else if (!kivLdapUnit.getOrganizationalUnitNameShort()
        ...
        if (kivLdapUnit.getVgrInternalSedfInvoiceAddress() == null) {
            if (kivwsUnit.getVgrInternalSedfInvoiceAddress() != null)
                return false;
        } else if (!kivLdapUnit.getVgrInternalSedfInvoiceAddress().equals(
                kivwsUnit.getVgrInternalSedfInvoiceAddress()))
            return false;
        ...
        if (Double.doubleToLongBits(kivLdapUnit.getWgs84Lat()) != Double.doubleToLongBits(kivwsUnit.getWgs84Lat()))
            return false;
        if (Double.doubleToLongBits(kivLdapUnit.getWgs84Long()) != Double.doubleToLongBits(kivwsUnit
                .getWgs84Long()))
            return false;
        return true;
    }
