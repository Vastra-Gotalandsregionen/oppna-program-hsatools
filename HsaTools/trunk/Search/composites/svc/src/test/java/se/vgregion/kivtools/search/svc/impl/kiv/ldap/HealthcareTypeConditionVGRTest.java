...
public class HealthcareTypeConditionVGRTest {
  ...
  public void testRealFile() {
    ...
    assertEquals("01", healthcareType.getConditions().get("careType"));
    ...
    assertNotNull(healthcareType);
    assertEquals("01", healthcareType.getConditions().get("hsaBusinessType"));
    assertFalse(healthcareType.isFiltered());
    ...
    assertNotNull(healthcareType);
    assertEquals("02", healthcareType.getConditions().get("hsaBusinessType"));
    assertFalse(healthcareType.isFiltered());
