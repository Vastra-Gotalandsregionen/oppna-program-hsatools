 ...
 *
 * Object pool to handle LDAPConnection
 * usage:
 * getConnection()
 * ...
 * releaseConnection()
...
public class LdapConnectionPool {
    ...
    private List<LDAPConnection> freeConnections = new ArrayList<LDAPConnection>(); // not synchronized since all access already is synchronized
    private int checkedOut;
    private final static int NOT_INITIALIZED = -123456;
    private final static int MAX_CONN_DEFAULT = 10;
    ...
    private String    ldapHost    = null; //"138.233.20.80:389";
    private String    loginDN     = null; //"cn=sokso1,ou=Resurs,o=VGR";
    private String    password    = null; //"6wuz8zab";
    ...
    public synchronized void release() {
        ...
        while (allConnections.hasNext()) {
            LDAPConnection con = (LDAPConnection) allConnections.next();
            try {
                con.disconnect();
