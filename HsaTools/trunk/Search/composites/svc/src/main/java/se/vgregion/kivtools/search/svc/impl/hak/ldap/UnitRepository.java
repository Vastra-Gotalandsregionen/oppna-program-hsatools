...
public class UnitRepository {
	 ...
	 *            List only units with these bs codes.
	...
	public List<String> getAllUnitsHsaIdentity(List<Integer> showUnitsWithTheseHsaBussinessClassificationCodes) throws KivException {
		...
		Filter businessClassificationCodeFilter = createBusinessClassificationCodeFilter(showUnitsWithTheseHsaBussinessClassificationCodes,
	 ...
	 * 
	 * @param businessClassificationCodes
	 *            The list of business classification codes to include.
	 * @param healthcareTypes
	 *            The list of health care types to include.
	 ...
	 *            The health care type to create a filter for.
	 * @return A populated filter.
	 */
