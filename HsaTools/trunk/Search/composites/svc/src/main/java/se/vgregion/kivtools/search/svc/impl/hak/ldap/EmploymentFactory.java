...
public class EmploymentFactory {
    ...
    public static Employment reconstitute(LDAPEntry employmentEntry) {
        ...
        //Anst�llningsperiod
        employment.setEmploymentPeriod(
                TimePoint.parseFrom(
                        LdapORMHelper.getSingleValue(employmentEntry.getAttribute("hsaStartDate")),
                        ""/*TODO Add pattern*/,
                        TimeZone.getDefault()
                ),
                TimePoint.parseFrom(
                        LdapORMHelper.getSingleValue(employmentEntry.getAttribute("hsaEndDate")),
                        ""/*TODO Add pattern*/,
                        TimeZone.getDefault()
                )
        );
