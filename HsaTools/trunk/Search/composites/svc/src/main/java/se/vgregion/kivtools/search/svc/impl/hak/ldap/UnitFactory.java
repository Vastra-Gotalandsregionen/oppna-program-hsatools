...
import se.vgregion.kivtools.search.svc.impl.hak.ldap.LdapORMHelper;
...
public class UnitFactory {
    ...
    public static Unit reconstitute(LDAPEntry unitEntry) throws Exception {
        ...
        String orgName = Formatter.replaceStringInString(unit.getOu(), "\\,", ","); // change \, to ,
        unit.setName(orgName); // special
        ...
        unit.setHsaSedfSwitchboardTelephoneNo(PhoneNumber
                .createPhoneNumber(LdapORMHelper.getSingleValue(unitEntry
                        .getAttribute("hsaSwitchboardTelephoneNo"))));
        ...
        addressList.add(LdapORMHelper.getSingleValue(unitEntry.getAttribute("postalCode"))
                + " " + LdapORMHelper.getSingleValue(unitEntry.getAttribute("l")));
        ...
        // �garform klartext
        unit.setHsaManagementName(LdapORMHelper.getSingleValue(unitEntry
                .getAttribute("hsaManagementName")));
		...
		// hsaVisitingRuleAge 
        unit.setHsaVisitingRuleAge(LdapORMHelper
                .getSingleValue(unitEntry
                        .getAttribute("hsaVisitingRuleAge")));
		
		// management 
        unit.setHsaManagementText(getManagementDescription(LdapORMHelper
                .getSingleValue(unitEntry
                        .getAttribute("management"))));
