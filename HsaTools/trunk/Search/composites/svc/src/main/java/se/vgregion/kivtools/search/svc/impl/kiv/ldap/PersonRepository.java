    ...
    public List<String> getAllPersonsVgrId() throws KivException {
        ...
        AttributesMapper attributesMapper = new AttributesMapper() {
            ...
            public String mapFromAttributes(Attributes attributes) throws NamingException {
                ...
                Attribute attribute = attributes.get("vgr-id");
                if (attribute != null) {
        ...
        try {
            List<String> vgrIds = ldapTemplate.search(PERSON_SEARCH_BASE, andFilter.encode(),
                    SearchControls.ONELEVEL_SCOPE, attributes, attributesMapper);
