...
public class DN implements Serializable, Comparator<DN>, Iterable<DN> {
    ...
    private String o;
    private static final int ADMINISTRATION = -3; //Position of administration OU
    
    public DN(List<String> cn, List<String> ou, String o) {
    ...
    public String getIsUnitAndAdministrationOnSameLevel() {
    	boolean temp = (this.ou.size()<=2); // HAGY fix, for taking care of special case
    	return "" + temp;
    }
    ...
    public DN getUnit() {
        ...
        return DN.createDNFromString(str.toString());
    }
    ...
    public DN getParentDN() {
        ...
        return new DN(theCN, theOU, this.o);
    }
     ...
     * @return returns the specified number of generations.
     * 
     * Use 0 for all generations.
     * A positive number to get an exact count of generations.
     * A negative number to get all generations except for the last n generations.
     */
    ...
    /**
     * The method is mainly used when creating links to units. This can cause problems if the link contains 
     * special characters like ������. 
     * The method takes care of encoding incompatibility problems between IBM WAS and Apache Tomcat.  
     * 
    ...
    public String getUrlEncoded() {
        try {
            if(EnvAssistant.isRunningOnIBM()) {
                ...
                // Ok we don�t run on IBM (maybe Tomcat) so let�s make url encoding like this
    ...
    private class DNIterator implements Iterator<DN> {
        ...
        public DN next() {
            ...
            return new DN(theCn, theOu, theO);
        }
