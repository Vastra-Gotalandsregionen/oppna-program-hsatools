...
//    return returnTimeList;
    ...
    public String getSaveValue() {
        return this.getStartDay() + "-" + this.getEndDay() + "#" +
                this.getTwoDigitNumber(this.getStartHour()) + ":" + this.getTwoDigitNumber(this.getStartMin()) + "#" + this.getTwoDigitNumber(this.getEndHour()) + ":" + this.getTwoDigitNumber(this.getEndMin());
    }
