...
/**
 * Since the conversion WGS <-> RT90 can be carried out in multiple ways the
 * conversion implementations should implement this simple contract.
 * 
...
public interface CoordinateTransformerService {
	 ...
	 * 
	 * @param lat
	 *            Latitude in WGS84 degrees, decimal format
	 * @param lon
	 *            Longitude in WGS84 degrees, decimal format.
