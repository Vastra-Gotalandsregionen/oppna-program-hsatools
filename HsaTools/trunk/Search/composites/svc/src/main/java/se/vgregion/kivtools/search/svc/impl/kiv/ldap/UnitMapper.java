...
public class UnitMapper implements ContextMapper {
  ...
  public Unit mapFromContext(Object ctx) {
    ...
    String vgrAO3Text = codeTablesService.getValueFromCode(CodeTableName.VGR_AO3_CODE, context.getString(UnitLdapAttributes.VGR_AO3_KOD));
    unit.setVgrAO3kodText(vgrAO3Text);

    unit.setVgrCareType(context.getString(UnitLdapAttributes.VGR_CARE_TYPE));
    String vgrCareTypeText = codeTablesService.getValueFromCode(CodeTableName.VGR_CARE_TYPE, UnitLdapAttributes.VGR_CARE_TYPE);
