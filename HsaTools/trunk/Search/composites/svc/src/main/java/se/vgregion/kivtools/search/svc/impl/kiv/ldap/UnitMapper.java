...
public class UnitMapper implements ContextMapper {
    ...
    public Unit mapFromContext(Object ctx) {
        ...
        unit.setFacsimileTelephoneNumber(PhoneNumber.createPhoneNumber(context
                .getString(UnitLdapAttributes.FACSIMILE_TELEPHONE_NUMBER)));
        unit.setHsaConsigneeAddress(AddressHelper.convertToAddress(context
                .getStrings(UnitLdapAttributes.HSA_CONSIGNEE_ADDRESS)));
        ...
        unit.setHsaDropInHours(WeekdayTime.createWeekdayTimeList(context
                .getStrings(UnitLdapAttributes.HSA_DROPIN_HOURS)));
        unit.setHsaEndDate(TimeUtil.parseStringToZuluTime(context.getString(UnitLdapAttributes.HSA_END_DATE)));
        unit.setHsaInternalAddress(AddressHelper.convertToAddress(context
                .getStrings(UnitLdapAttributes.HSA_INTERNAL_ADDRESS)));
        unit.setHsaInternalPagerNumber(PhoneNumber.createPhoneNumber(context
                .getString(UnitLdapAttributes.PAGER_TELEPHONE_NUMBER)));
        unit.setHsaPostalAddress(AddressHelper.convertToAddress(context
                .getStrings(UnitLdapAttributes.HSA_POSTAL_ADDRESS)));
        unit.setHsaPublicTelephoneNumber(PhoneNumber.createPhoneNumberList(context
                .getStrings(UnitLdapAttributes.HSA_PUBLIC_TELEPHONE_NUMBER)));
        unit.setHsaRoute(context.getStrings(UnitLdapAttributes.HSA_ROUTE));
        unit.setHsaSedfDeliveryAddress(AddressHelper.convertToAddress(context
                .getStrings(UnitLdapAttributes.HSA_SEDF_DELIVERY_ADDRESS)));
        unit.setHsaSedfInvoiceAddress(AddressHelper.convertToAddress(context
                .getStrings(UnitLdapAttributes.HSA_SEDF_INVOICE_ADDRESS)));
        unit.setHsaSedfSwitchboardTelephoneNo(PhoneNumber.createPhoneNumber(context
                .getString(UnitLdapAttributes.HSA_SEDF_SWITCHBOARD_TELEPHONE_NO)));
        unit.setHsaSmsTelephoneNumber(PhoneNumber.createPhoneNumber(context
                .getString(UnitLdapAttributes.HSA_SMS_TELEPHONE_NUMBER)));
        unit.setHsaStreetAddress(AddressHelper.convertToStreetAddress(context
                .getStrings(UnitLdapAttributes.HSA_STREET_ADDRESS)));
        unit.setHsaSurgeryHours(WeekdayTime.createWeekdayTimeList(context
                .getStrings(UnitLdapAttributes.HSA_SURGERY_HOURS)));
        unit.setHsaTelephoneNumber(PhoneNumber.createPhoneNumberList(context
                .getStrings(UnitLdapAttributes.HSA_TELEPHONE_NUMBER)));
        unit.setHsaTelephoneTime(WeekdayTime.createWeekdayTimeList(context
                .getStrings(UnitLdapAttributes.HSA_TELEPHONE_TIME)));
        unit.setHsaTextPhoneNumber(PhoneNumber.createPhoneNumber(context
                .getString(UnitLdapAttributes.HSA_TEXT_PHONE_NUMBER)));
        ...
        unit.setMobileTelephoneNumber(PhoneNumber.createPhoneNumber(context
                .getString(UnitLdapAttributes.MOBILE_TELEPHONE_NUMBER)));
        ...
        unit.setPagerTelephoneNumber(PhoneNumber.createPhoneNumber(context
                .getString(UnitLdapAttributes.PAGER_TELEPHONE_NUMBER)));
        ...
        unit.setVgrInternalSedfInvoiceAddress(context
                .getString(UnitLdapAttributes.VGR_INTERNAL_SEDF_INVOICE_ADDRESS));
        ...
        unit.setVisitingHours(WeekdayTime.createWeekdayTimeList(context
                .getStrings(UnitLdapAttributes.HSA_VISITING_HOURS)));
    ...
    private boolean isUnitType(String objectClass) {
        ...
        if (objectClass.equalsIgnoreCase(Constants.OBJECT_CLASS_UNIT_SPECIFIC)
                || objectClass.equalsIgnoreCase(Constants.OBJECT_CLASS_UNIT_STANDARD)) {
            isUnitType = true;
    ...
    private void assignCodeTableValuesToUnit(Unit unit) {
        ...
        unit.setHsaBusinessClassificationCode(context
                .getStrings(UnitLdapAttributes.HSA_BUSINESS_CLASSIFICATION_CODE));

        List<String> businessText = new ArrayList<String>();
        for (String businessCode : unit.getHsaBusinessClassificationCode()) {
            String hsaBusinessClassificationText = codeTablesService.getValueFromCode(
                    CodeTableName.HSA_BUSINESSCLASSIFICATION_CODE, businessCode);
        ...
        String hsaHsaAdministrationFormText = codeTablesService.getValueFromCode(
                CodeTableName.HSA_ADMINISTRATION_FORM, administrationCode);
        ...
        String vgrCareTypeText = codeTablesService.getValueFromCode(CodeTableName.VGR_CARE_TYPE, unit
                .getVgrCareType());
        ...
        String municipalityName = codeTablesService.getValueFromCode(CodeTableName.HSA_MUNICIPALITY_CODE, unit
