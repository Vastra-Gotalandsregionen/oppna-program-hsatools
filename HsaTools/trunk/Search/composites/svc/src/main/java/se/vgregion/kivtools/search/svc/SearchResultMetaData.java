...
public class SearchResultMetaData implements Serializable{
    ...
    private TimeMeasurement dataSourceSearchTime=new TimeMeasurement();  // used to measure the responsetime of the datasource e.g. LDAP
    private TimeMeasurement contextSearchTime=new TimeMeasurement(); // used to measure the overall response time
