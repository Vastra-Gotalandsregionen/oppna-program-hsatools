...
public class KivwsUnitMapper implements ContextMapper {
    ...
    public Unit mapFromContext(Object ctx) {
        ...
        unit.setHsaInternalAddress(AddressHelper
                .convertToAddress((List<String>) getMultiValue(KivwsAttributes.HSA_INTERNAL_ADDRESS)));
        unit.setHsaInternalPagerNumber(PhoneNumber
                .createPhoneNumber((String) getSingleValue(KivwsAttributes.PAGER_TELEPHONE_NUMBER)));
        unit.setHsaPostalAddress(AddressHelper
                .convertToAddress((List<String>) getMultiValue(KivwsAttributes.HSA_POSTAL_ADDRESS)));
        List<PhoneNumber> createPhoneNumberList = PhoneNumber
                .createPhoneNumberList((List<String>) getMultiValue(KivwsAttributes.HSA_PUBLIC_TELEPHONE_NUMBER));
        ...
        unit.setHsaSedfDeliveryAddress(AddressHelper
                .convertToAddress((List<String>) getMultiValue(KivwsAttributes.HSA_SEDF_DELIVERY_ADDRESS)));
        unit.setHsaSedfInvoiceAddress(AddressHelper
        ...
        unit.addHsaSurgeryHours(WeekdayTime
                .createWeekdayTimeList((List<String>) getMultiValue(KivwsAttributes.HSA_SURGERY_HOURS)));
        unit.addHsaTelephoneNumber(PhoneNumber
                .createPhoneNumberList((List<String>) getMultiValue(KivwsAttributes.HSA_TELEPHONE_NUMBER)));
        unit.addHsaTelephoneTimes(WeekdayTime
                .createWeekdayTimeList((List<String>) getMultiValue(KivwsAttributes.HSA_TELEPHONE_TIME)));
        unit.setHsaTextPhoneNumber(PhoneNumber
                .createPhoneNumber((String) getSingleValue(KivwsAttributes.HSA_TEXT_PHONE_NUMBER)));
        ...
        unit.setMobileTelephoneNumber(PhoneNumber
                .createPhoneNumber((String) getSingleValue(KivwsAttributes.MOBILE_TELEPHONE_NUMBER)));
        ...
        unit
                .setOrganizationalUnitNameShort((String) getSingleValue(KivwsAttributes.ORGANIZATIONAL_UNITNAME_SHORT));
        ...
        unit.setVisitingHours(WeekdayTime
                .createWeekdayTimeList((List<String>) getMultiValue(KivwsAttributes.HSA_VISITING_HOURS)));
    ...
    private void assignCodeTableValuesToUnit(Unit unit) {
        ...
        unit
                .setHsaBusinessClassificationCode((List<String>) getMultiValue(KivwsAttributes.HSA_BUSINESS_CLASSIFICATION_CODE));
