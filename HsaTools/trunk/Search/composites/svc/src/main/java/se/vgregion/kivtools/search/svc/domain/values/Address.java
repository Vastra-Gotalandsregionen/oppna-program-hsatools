 ...
 * 
 * example: 
 * street=Per Dubbsgatan 15
 * zipCode=45145
 * city=Uddevalla
 * additional info=Ta vänster vid norra porten, hiss till plan 7
 */
...
public class Address implements Serializable, IsEmptyMarker {
    ...
    private String city="";
    private List<String> additionalInfo=new ArrayList<String>(); // the rest of the address stuff that can't be converted
