...
public class PojoTester {
  ...
  public static <T> void testProperty(Object object, String propertyName, Class<T> type, T defaultValue, T testValue1, T testValue2) {
    assertEquals("Unexpected default value", defaultValue, ReflectionUtil.getProperty(object, propertyName));
    ReflectionUtil.setProperty(object, propertyName, type, testValue1);
    assertEquals("Unexpected testvalue1", testValue1, ReflectionUtil.getProperty(object, propertyName));
    ReflectionUtil.setProperty(object, propertyName, type, testValue2);
    assertEquals("Unexpected testvalue2", testValue2, ReflectionUtil.getProperty(object, propertyName));
  }
}
