...
function searchUnitsExternal(proxyUrl, urlParam, rootUrl, webappName, municipalityId, resultOnly, googleMapsKey) {
	...
	searchUnits(url, rootUrl, webappName, municipalityId, resultOnly, googleMapsKey);
}
...
function searchUnits(url, rootUrl, webappName, municipalityId, resultOnly, googleMapsKey) {
