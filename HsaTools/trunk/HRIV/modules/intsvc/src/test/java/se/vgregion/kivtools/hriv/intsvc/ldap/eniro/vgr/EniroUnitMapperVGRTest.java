...
public class EniroUnitMapperVGRTest {
  ...
  public void testMapCn() {
    ...
    this.dirContextOperationsMock.addAttributeValue("hsaStreetAddress", this.ldapAddressValue);
    this.dirContextOperationsMock.addAttributeValue("hsaGeographicalCoordinates", "X: 6414080, Y: 1276736");
    UnitComposition unitComposition = (UnitComposition) this.eniroUnitMapper.mapFromContext(this.dirContextOperationsMock);
    assertNotNull(unitComposition);
  ...
  public void telephoneNumbersAreFormattedRatherThanHsaStandard() {
    this.dirContextOperationsMock.addAttributeValue("hsaPublicTelephoneNumber", "+46313450700");
    this.dirContextOperationsMock.addAttributeValue("hsaTelephoneTime", "1-5#08:00#18:00");
  ...
  private void setAttributeMocks() {
    ...
    this.dirContextOperationsMock.addAttributeValue("hsaSurgeryHours", "1#08:00#19:00$2-5#08:00#17:00");
    this.dirContextOperationsMock.addAttributeValue("hsaBusinessClassificationCode", "1");
    this.dirContextOperationsMock.addAttributeValue("l", "locality");
    this.dirContextOperationsMock.addAttributeValue("hsaRoute", "Nedför backen$Till höger vid stenen$In under bron");
  }
}
