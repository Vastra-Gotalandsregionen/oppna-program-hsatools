...
public class OrganisationPrinterTest {
  ...
  public void printOutRealOrganisation() throws Exception{
    ...
    Organization generateOrganisation = eniroOrganisationBuilder.generateOrganisation(getUnitsFromLdap(getLdapTemplet()));
    organisationPrinter = new OrganisationPrinter();
    stringWriter = new StringWriter();
  ...
  private LdapTemplate getLdapTemplet() throws Exception{
