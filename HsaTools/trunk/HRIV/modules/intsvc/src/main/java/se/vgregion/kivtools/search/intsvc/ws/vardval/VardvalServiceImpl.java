...
import se.vgregion.kivtools.search.intsvc.ws.domain.vardval.GetVårdvalRequest;
import se.vgregion.kivtools.search.intsvc.ws.domain.vardval.GetVårdvalResponse;
import se.vgregion.kivtools.search.intsvc.ws.domain.vardval.IVårdvalService;
import se.vgregion.kivtools.search.intsvc.ws.domain.vardval.ObjectFactory;
import se.vgregion.kivtools.search.intsvc.ws.domain.vardval.SetVårdvalRequest;
import se.vgregion.kivtools.search.intsvc.ws.domain.vardval.SetVårdvalResponse;
import se.vgregion.kivtools.search.intsvc.ws.domain.vardval.VårdvalEntry;
