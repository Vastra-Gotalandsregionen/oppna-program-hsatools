...
import se.vgregion.kivtools.search.intsvc.ws.domain.sahlgrenska.Address;
import se.vgregion.kivtools.search.intsvc.ws.domain.sahlgrenska.AddressType;
import se.vgregion.kivtools.search.intsvc.ws.domain.sahlgrenska.Description;
import se.vgregion.kivtools.search.intsvc.ws.domain.sahlgrenska.EAliasType;
import se.vgregion.kivtools.search.intsvc.ws.domain.sahlgrenska.ObjectFactory;
import se.vgregion.kivtools.search.intsvc.ws.domain.sahlgrenska.Organization;
import se.vgregion.kivtools.search.intsvc.ws.domain.sahlgrenska.TelephoneType;
import se.vgregion.kivtools.search.intsvc.ws.domain.sahlgrenska.UnitType;
import se.vgregion.kivtools.search.intsvc.ws.domain.sahlgrenska.AddressType.GeoCoordinates;
import se.vgregion.kivtools.search.intsvc.ws.domain.sahlgrenska.UnitType.Locality;
import se.vgregion.kivtools.search.intsvc.ws.domain.sahlgrenska.UnitType.VisitingConditions;
...
public class UnitDetailsServiceImpl implements UnitDetailsService<Organization> {
	...
	private se.vgregion.kivtools.search.intsvc.ws.domain.sahlgrenska.Unit generateWebServiceUnit(Unit unit) {
		se.vgregion.kivtools.search.intsvc.ws.domain.sahlgrenska.Unit unitWs = objectFactory.createUnit();
