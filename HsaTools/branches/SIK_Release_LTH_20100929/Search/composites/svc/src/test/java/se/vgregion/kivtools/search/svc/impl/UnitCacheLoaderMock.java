...
class UnitCacheLoaderMock implements CacheLoader<UnitCache> {
  @Override
  ...
  public UnitCache loadCache() {
    ...
    unitCache.add(createUnit("ABC-123", "Mölndals Sjukhus", TimePoint.atMidnightGMT(2010, 2, 10), null));
    unitCache.add(createUnit("XYZ-987", "Angereds vårdcentral", TimePoint.atMidnightGMT(2010, 2, 10), TimePoint.atMidnightGMT(2010, 2, 16)));
    unitCache.add(createUnit("JKL-654", "Slottsskogens vårdcentral", TimePoint.atMidnightGMT(2010, 2, 16), TimePoint.atMidnightGMT(2010, 2, 16)));
