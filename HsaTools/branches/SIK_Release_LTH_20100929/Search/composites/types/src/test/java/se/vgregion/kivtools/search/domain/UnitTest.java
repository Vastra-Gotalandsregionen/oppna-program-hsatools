...
public class UnitTest {
  ...
  public void testBasicProperties() throws InvalidFormatException {
    ...
    PojoTester.testProperty(this.unit, "vgrEANCode", String.class, null, TEST, TEST2);
    ...
    PojoTester.testProperty(this.unit, "hsaSmsTelephoneNumber", PhoneNumber.class, null, PhoneNumber.createPhoneNumber(TEST), PhoneNumber.createPhoneNumber(TEST2));
    ...
    PojoTester.testProperty(this.unit, "vgrEDICode", String.class, null, TEST, TEST2);
