...
public final class DN implements Serializable, Iterable<DN> {
     ...
     * 
     * @param cn
     *            The list of common names to use.
     * @param ou
     *            The list of organizational units to use.
     * @param dc
     *            The list of domain components to use.
     * @param o
    ...
    /**
     * Constructs a new DN instance using the provided DN as a base but sets the DN's position to the provided
     * value.
     * 
     * @param originalDn
     *            The DN to base the new DN on.
     * @param position
     *            The new value for position for this DN.
     */
     ...
     * 
     * @param dnString
     *            The DN-string to base the DN instance on.
     ...
     * 
     * @return The string "true" if the unit is at the same level as it's administration, otherwise the string
     *         "false".
     */
     ...
     * 
     * @return null if the unit is above the administration level, the unit itself if the unit is at the
     *         administration level and an ancestor at the administration level otherwise.
     */
     ...
     * 
     * @param rootLevel
     *            The minimum level of the organizational unit.
    ...
    /**
     * Gets a list of the DN's ancestors starting with the provided fromGeneration and ending at the provided
     * toGeneration.
     * 
     * @param fromGeneration
     *            The first generation to return.
     * @param toGeneration
     *            The last generation to return.
     * @return returns a list of the DN's ancestors starting with the provided fromGeneration and ending at the
     *         provided toGeneration.
     */
     ...
     * 
     * @param generation
     *            The generation to get. Use 0 for all generations. A positive number to get an exact count of
     *            generations. A negative number to get all generations except for the last n generations.
    ...
    /**
     * The method is mainly used when creating links to units. This can cause problems if the link contains special
     * characters like ������. The method takes care of encoding incompatibility problems between IBM WAS and
     * Apache Tomcat.
     * 
